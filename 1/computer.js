class Computer {
    ...
    static addToStorage(data) {
        ...
        this.storageuse += data.size()
            ...
            localStorage.setItem("Computer",JSON.stringify({totalram:this.totalram,totalstorage:this.totalstorage,storageuse:this.storageuse,storage:this.storage,version:this.version}))
        }
    }
