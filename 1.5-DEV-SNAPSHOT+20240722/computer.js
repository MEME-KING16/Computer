class Computer {
    ...
    static loadCustomVersion(version) {
        if (this.modded == false) {
            if (confirm("You dont have modded versions enabled would you like to enable it?")) {
                this.modded = true
                if (confirm("Are you sure that you want to load a custom version this could cause issues and break if the version file dosent exist?")) {
